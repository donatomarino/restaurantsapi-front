  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full text-white focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-gradient-to-br from-yellow-400 via-yellow-500 to-yellow-600 hover:brightness-110 transition duration-200"
        >
          Iniciar sesión
        </button>
      </form>
